...
saveRDS(weighted_ensemble, "data/weighted_constrianed_ensemble.RDS")
...
saveRDS(gsat_95_to_14, "data/weighted_eoc_gsat_ensemble.RDS")
```
...
eoc_gsat_ensemble <- Map(merge, eoc_warming_results, ensemble_normalized, by = "run_number")
...
names(temp_probability_sequence) <- names(eoc_gsat_ensemble)
